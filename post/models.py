...
class JobPostActivity(models.Model):
    ...
    post_status = models.ForeignKey(UserPostStatus, on_delete=models.CASCADE, default=1)
    apply_status= models.ForeignKey(ApplyStatus, on_delete=models.CASCADE, default=1)
